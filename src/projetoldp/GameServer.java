                                                    ...
                                                    if (casa.posicao.contains(pecaEscolhida)) {
                                                        ...
                                                        if (podeMover) {
                                                            if (podeAtacar) {
                                                                ...
                                                                enviar = "#jogada" + "-" + peca + "-" + String.valueOf(mover) + "-" + String.valueOf(casa.id + mover);
                                                            }
                                                        }
                                                    }
                                                }
